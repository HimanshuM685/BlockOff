...
import LogWindowContainer from '@/components/LogWindowContainer';
...
const CustomLightTheme = {
  ...
  colors: {
    ...
    card: Colors.neoBrutalism.surface,
    text: Colors.neoBrutalism.text,
    border: Colors.neoBrutalism.border,
    notification: Colors.neoBrutalism.secondary,
  },
};
        ...
        <BleProvider>
          <WalletProvider>
            <ThemeProvider value={CustomLightTheme}>
              <Stack>
                ...
                <Stack.Screen
                  ...
                  options={{
                    ...
                    presentation: 'modal',
                    headerShown: true,
                    headerStyle: { backgroundColor: Colors.neoBrutalism.surface },
                    headerTintColor: Colors.neoBrutalism.text,
                  }}
                />
                <Stack.Screen
              ...
              {/* Log Window Container - Always visible */}
              <LogWindowContainer />
            </ThemeProvider>
          </WalletProvider>
        </BleProvider>
