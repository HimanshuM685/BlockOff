...
export const NeoBrutalButton: React.FC<NeoBrutalButtonProps> = ({
  ...
  const getButtonStyle = () => {
    ...
    switch (variant) {
      case 'primary':
        return {
          ...baseStyle,
          backgroundColor: NeoBrutalismColors.primary, // Blue Background
          borderColor: '#000000', // Black Border
          ...NeoBrutalismShadows.brutalWhite, // White Shadow
        };
      case 'secondary':
        return {
          ...baseStyle,
          ...
          ...NeoBrutalismShadows.brutalBlue, // Blue Shadow
        };
      case 'accent':
        return {
          ...baseStyle,
          backgroundColor: NeoBrutalismColors.accent, // Green
          borderColor: '#000000',
          ...NeoBrutalismShadows.brutalWhite,
        };
      case 'outline':
        return {
          ...baseStyle,
  ...
  const getTextStyle = () => {
    ...
    return {
      ...baseTextStyle,
      color: variant === 'outline' || variant === 'secondary' ? NeoBrutalismColors.text : NeoBrutalismColors.textInverse,
    };
  };
  ...
  const getCardStyle = () => {
    ...
    switch (variant) {
      case 'primary':
        return {
          ...baseStyle,
          backgroundColor: NeoBrutalismColors.surface, // Black
          borderColor: NeoBrutalismColors.border, // Blue
...
const styles = StyleSheet.create({
  ...
  buttonText: {
    fontWeight: NeoBrutalismTypography.weights.bold as any,
    letterSpacing: 1,
  },
  buttonTextSmall: {
  ...
  heroTitle: {
    ...
    fontWeight: NeoBrutalismTypography.weights.heavy as any,
  ...
  subtitle: {
    fontSize: NeoBrutalismTypography.sizes.md,
    fontWeight: NeoBrutalismTypography.weights.medium as any,
